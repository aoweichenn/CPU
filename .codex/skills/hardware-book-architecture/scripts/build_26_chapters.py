...
EXTRAS = {
    ...
    13: ("ch13-cacheline-read-transaction.tex", "ch13-cacheline-write-transaction.tex", "ch13-chapter-exercises.tex"),
    ...
    19: ("ch19-device-queues.tex", "ch19-nic-rx-lifecycle.tex", "ch19-runtime-hardware-security.tex", "ch19-dma-interrupt-virtualization.tex", "ch19-vm-entry-exit-lifecycle.tex"),
    20: ("ch20-battery-pmic-power-path.tex",),
    21: ("ch21-platform-recovery.tex", "ch21-firmware-deep-dive.tex", "ch21-reset-runtime-firmware.tex", "ch21-board-manufacturing-bringup.tex", "ch21-power-button-reset-vector.tex", "ch21-multicore-bringup.tex"),
