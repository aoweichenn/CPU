...
EXTRAS = {
    ...
    11: ("ch11-cache-interface.tex", "ch11-cache-deep-dive.tex", "ch11-store-miss-lifecycle.tex"),
    12: ("ch12-modern-vm-tlb.tex", "ch12-vm-deep-dive.tex", "ch12-memory-attributes-migration.tex", "ch12-allocation-lifecycle.tex", "ch12-sv39-store-walk.tex"),
    13: ("ch13-cacheline-read-transaction.tex", "ch13-cacheline-write-transaction.tex", "ch13-ddr5-runtime-ras-lifecycle.tex", "ch13-chapter-exercises.tex"),
    14: ("ch14-nvme-interface.tex", "ch14-mobile-emerging-storage.tex", "ch14-zns-fdp-placement.tex"),
    15: ("ch15-ahci-command-recovery.tex", "ch15-chapter-exercises.tex"),
    16: ("ch16-persistence-reliability.tex", "ch16-block-layer-raid.tex", "ch16-nvmeof-multipath.tex"),
    17: ("ch17-handshake-axi.tex", "ch17-axi-transaction-traces.tex", "ch17-noc-deep-dive.tex", "ch17-coherence-power-domains.tex", "ch17-mesh-noc-roundtrip.tex"),
    18: ("ch18-pcie-transactions.tex", "ch18-pcie-deep-dive.tex", "ch18-cxl-chiplet.tex", "ch18-switch-virtualization.tex", "ch18-ecam-runtime-evidence.tex"),
    19: ("ch19-device-queues.tex", "ch19-nic-rx-lifecycle.tex", "ch19-runtime-hardware-security.tex", "ch19-physical-attack-resilience.tex", "ch19-tpm-remote-attestation.tex", "ch19-dma-interrupt-virtualization.tex", "ch19-vm-entry-exit-lifecycle.tex", "ch19-nested-virtualization-live-migration.tex"),
    20: ("ch20-battery-pmic-power-path.tex",),
    21: ("ch21-platform-recovery.tex", "ch21-firmware-deep-dive.tex", "ch21-reset-runtime-firmware.tex", "ch21-board-manufacturing-bringup.tex", "ch21-productization-emc-failure-analysis.tex", "ch21-power-button-reset-vector.tex", "ch21-multicore-bringup.tex", "ch21-numa-hotplug-lifecycle.tex"),
    22: ("ch22-dvfs-transition.tex", "ch22-ras-reliability.tex", "ch22-ras-deep-dive.tex", "ch22-bmc-availability.tex", "ch22-silicon-package-aging.tex", "ch22-functional-safety-determinism.tex"),
    23: ("ch23-ethernet-phy.tex", "ch23-usb-human-interface.tex", "ch23-sensor-acquisition.tex", "ch23-wireless-datacenter-fieldbus.tex", "ch23-audio-dma-lifecycle.tex", "ch23-imu-fifo-dma-trace.tex"),
    24: ("ch24-gpu-memory-visibility.tex", "ch24-display-camera-accelerator.tex", "ch24-frame-visible-lifecycle.tex"),
    26: ("ch26-modern-system-trace.tex", "ch26-hardware-trace-observability.tex", "ch26-safety-evidence-case.tex"),
}
EXTRAS_BEFORE = {
