...
EXTRAS = {
    ...
    19: ("ch19-device-queues.tex", "ch19-nic-rx-lifecycle.tex", "ch19-runtime-hardware-security.tex", "ch19-dma-interrupt-virtualization.tex", "ch19-vm-entry-exit-lifecycle.tex", "ch19-nested-virtualization-live-migration.tex"),
