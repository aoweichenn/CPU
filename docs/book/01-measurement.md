...
```bash
bash labs/lab00_benchmark_foundation/scripts/run_lab00.sh
cp results/lab00/summary.md results/lab00/summary_run1.md
bash labs/lab00_benchmark_foundation/scripts/run_lab00.sh
cp results/lab00/summary.md results/lab00/summary_run2.md
bash labs/lab00_benchmark_foundation/scripts/run_lab00.sh
cp results/lab00/summary.md results/lab00/summary_run3.md
```
...
build/lab00-release/labs/lab00_benchmark_foundation/lab00_bench \
  ...
  --warmup 3 \
  --iterations 10 \
  --csv results/lab00/size_scan.csv

tools/summarize_bench_csv.py results/lab00/size_scan.csv
```
