...
\subsection{signed 和 unsigned 的分叉}
...
\subsubsection{什么时候不要盲目追求 branchless}
...
\subsection{循环形态：while、do-while 和 for}
...
\subsection{实验 12.1：signed 和 unsigned 条件码}
...
\subsection{实验 12.3：分支和 branchless 对比}
...
\subsection{实验 12.4：switch 和跳转表}
...
\subsection{实验 12.5：call/ret 和返回地址}
...
\subsubsection*{作业 4：call/ret 地址审计}
