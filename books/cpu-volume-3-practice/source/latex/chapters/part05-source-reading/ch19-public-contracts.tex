...
GGUF 头文件固定 llama.cpp 生态模型文件的读取边界：版本、metadata、alignment、tensor 名、shape、ggml type 和 tensor payload offset。它不负责 tokenizer 或模型图执行，只把“真实 GGUF 文件里有哪些 tensor、每个 tensor 在哪里”变成可检查对象。
