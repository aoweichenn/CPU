...
\filepath{include/lcqi/ggml\_tensors.hpp} 与 \filepath{src/ggml\_tensors.cpp} & \code{dequantize\_ggml\_tensor}、\code{ggml\_f16\_to\_f32}。 & 把 GGUF 中的 \code{F32}、\code{Q8\_0}、\code{Q5\_0}、\code{Q6\_K} 和 \code{Q4\_K} 张量统一解到 f32。SmolLM2 Q4\_K\_M 不是单一 Q4\_K 文件，完整加载必须先处理这些混合格式。 \\
