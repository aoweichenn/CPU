...
\begin{waveform}[x=2pt,y=6ex]
  \draw[BookRule!20,step=20pt] (0,-10ex) grid (300pt,30ex);
  % CLK at top — 高:24ex, 低:18ex
  \draw[BookAccent,line width=3pt] (0,18ex) -- (0,24ex) -- (32pt,24ex) -- (32pt,18ex) -- (64pt,18ex) -- (64pt,24ex) -- (96pt,24ex) -- (96pt,18ex) -- (128pt,18ex) -- (128pt,24ex) -- (160pt,24ex) -- (160pt,18ex) -- (192pt,18ex) -- (192pt,24ex) -- (224pt,24ex) -- (224pt,18ex) -- (256pt,18ex) -- (256pt,24ex) -- (280pt,24ex) -- (280pt,18ex) -- (300pt,18ex);
  \node[BookAccent,left,font=\normalsize] at (0,21ex) {CLK};
  % D in middle — 高:11ex, 低:4ex
  \draw[BookAmber,line width=3pt] (0,4ex) -- (20pt,4ex) -- (20pt,11ex) -- (72pt,11ex) -- (72pt,4ex) -- (128pt,4ex) -- (128pt,11ex) -- (176pt,11ex) -- (176pt,4ex) -- (224pt,4ex) -- (224pt,11ex) -- (272pt,11ex) -- (272pt,4ex) -- (300pt,4ex);
  \node[BookAmber,left,font=\normalsize] at (0,7.5ex) {D};
  % Q at bottom — 高:-2ex, 低:-8ex
  \draw[BookTeal,line width=3pt] (0,-8ex) -- (32pt,-8ex) -- (32pt,-2ex) -- (96pt,-2ex) -- (96pt,-8ex) -- (160pt,-8ex) -- (160pt,-2ex) -- (224pt,-2ex) -- (224pt,-8ex) -- (280pt,-8ex) -- (280pt,-2ex) -- (300pt,-2ex);
  \node[BookTeal,left,font=\normalsize] at (0,-5ex) {Q};
  % Setup/hold windows
  \foreach \x in {20,76,132,188,244} {\fill[BookRed!25] (\x pt,17.5ex) rectangle (\x+12 pt,24.5ex);}
  \foreach \x in {32,96,160,224,280} {\fill[BookAmber!25] (\x pt,17.5ex) rectangle (\x+12 pt,24.5ex);}
  \node[BookRed,right,font=\small] at (32pt,27ex) {\code{t_{su}}};
  \node[BookAmber,right,font=\small] at (44pt,27ex) {\code{t_h}};
\end{waveform}
...
\begin{block}[x=2.0cm,y=1.6cm]
  ...
  \node[right] at ($(ff.east)+(0.12,-0.5)$) {Q'};
  \draw[BookAccent, very thick] ($(ff.west)+(-0.06,-0.5)$) -- ++(0.22,0) -- ++(0,0.22);
...
\begin{waveform}[x=2pt,y=6ex]
  ...
  \node[BookAccent,left,font=\normalsize] at (0,21ex) {CLK};
  % D in middle — 高:11ex, 低:4ex
  \draw[BookAmber,line width=3pt] (0,4ex) -- (20pt,4ex) -- (20pt,11ex) -- (72pt,11ex) -- (72pt,4ex) -- (300pt,4ex);
  \node[BookAmber,left,font=\normalsize] at (0,7.5ex) {D};
  % Q at bottom — 高:-2ex, 低:-8ex
  \draw[BookTeal,line width=3pt] (0,-8ex) -- (32pt,-8ex) -- (44pt,-8ex) -- (44pt,-2ex) -- (108pt,-2ex) -- (108pt,-8ex) -- (300pt,-8ex);
  \node[BookTeal,left,font=\normalsize] at (0,-5ex) {Q};
  % 右侧图例
  \draw[BookRed,line width=2.5pt,->] (270pt,22ex) -- (290pt,22ex) node[right,font=\small\bfseries,BookRed] {\code{tCQ}};
  \draw[BookAmber,line width=2.5pt,->] (270pt,14ex) -- (290pt,14ex) node[right,font=\small\bfseries,BookAmber] {组合逻辑延迟};
  \draw[BookTeal,line width=2.5pt,->] (270pt,6ex) -- (290pt,6ex) node[right,font=\small\bfseries,BookTeal] {\code{tSU}};
  % 波形上的标注箭头
  \draw[BookRed,line width=1.2pt,<->] (32pt,16ex) -- (44pt,16ex);
  \draw[BookAmber,line width=1.2pt,<->] (44pt,16ex) -- (96pt,16ex);
  \draw[BookTeal,line width=1.2pt,<->] (96pt,16ex) -- (108pt,16ex);
\end{waveform}
...
\begin{waveform}[x=2pt,y=6ex]
  \draw[BookRule!20,step=20pt] (0,-18ex) grid (300pt,34ex);
  % CLK at top — 高:28ex, 低:22ex
  \draw[BookAccent,line width=3pt] (0,22ex) -- (0,28ex) -- (32pt,28ex) -- (32pt,22ex) -- (64pt,22ex) -- (64pt,28ex) -- (96pt,28ex) -- (96pt,22ex) -- (128pt,22ex) -- (128pt,28ex) -- (160pt,28ex) -- (160pt,22ex) -- (192pt,22ex) -- (192pt,28ex) -- (224pt,28ex) -- (224pt,22ex) -- (256pt,22ex) -- (256pt,28ex) -- (280pt,28ex) -- (280pt,22ex) -- (300pt,22ex);
  \node[BookAccent,left,font=\normalsize] at (0,25ex) {CLK};
  % Async input — 高:17ex, 低:11ex
  \draw[BookAmber,line width=3pt] (0,11ex) -- (80pt,11ex) -- (80pt,17ex) -- (200pt,17ex) -- (200pt,11ex) -- (300pt,11ex);
  \node[BookAmber,left,font=\normalsize] at (0,14ex) {async input};
  % FF1 output — 有亚稳态振荡, 高:6ex, 低:-2ex
  \draw[BookRed,line width=3pt] (0,-2ex) -- (32pt,-2ex) -- (32pt,6ex) -- (80pt,6ex);
  \draw[BookRed,dashed,line width=3pt] (80pt,6ex) .. controls (92pt,10ex) and (108pt,0ex) .. (120pt,4ex);
  \draw[BookRed,line width=3pt] (120pt,4ex) -- (160pt,4ex) -- (160pt,-2ex) -- (200pt,-2ex);
  \draw[BookRed,dashed,line width=3pt] (200pt,-2ex) .. controls (212pt,3ex) and (228pt,10ex) .. (240pt,4ex);
  \draw[BookRed,line width=3pt] (240pt,4ex) -- (300pt,4ex);
  \node[BookRed,left,font=\normalsize] at (0,2ex) {FF$_1$ (meta)};
  % FF2 output — 稳定, 高:-8ex, 低:-14ex
  \draw[BookTeal,line width=3pt] (0,-14ex) -- (120pt,-14ex) -- (120pt,-8ex) -- (240pt,-8ex) -- (240pt,-14ex) -- (300pt,-14ex);
  \node[BookTeal,left,font=\normalsize] at (0,-11ex) {FF$_2$ (sync)};
  % Annotations
  \node[BookRed,font=\small,align=center] at (100pt,32ex) {亚稳态};
  \node[BookTeal,font=\small\bfseries] at (160pt,-17ex) {稳定输出};
\end{waveform}
