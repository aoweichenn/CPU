...
\begin{waveform}[x=2pt,y=6ex]
  ...
  % CLK — ++(32pt,0) 保持电平, ++(0,±6ex) 跳变
  \draw[BookAccent,line width=3pt]
    (0,26ex) -- ++(32pt,0) -- ++(0,-6ex) -- ++(32pt,0) -- ++(0,6ex)
             -- ++(32pt,0) -- ++(0,-6ex) -- ++(32pt,0) -- ++(0,6ex)
             -- ++(32pt,0) -- ++(0,-6ex) -- ++(32pt,0) -- ++(0,6ex)
             -- ++(32pt,0) -- ++(0,-6ex) -- ++(32pt,0) -- ++(0,6ex)
             -- ++(20pt,0);
  \node[BookAccent,left] at (0,23ex) {CLK};
  % D — 高 13ex, 低 5ex, 每周期 CLK↑前 12pt 建立
  \draw[BookAmber,line width=3pt]
    (0,5ex) -- ++(20pt,0) -- ++(0,8ex) -- ++(52pt,0) -- ++(0,-8ex) -- ++(56pt,0)
            -- ++(0,8ex) -- ++(48pt,0) -- ++(0,-8ex) -- ++(48pt,0)
            -- ++(0,8ex) -- ++(36pt,0);
  \node[BookAmber,left] at (0,9ex) {D};
  % Q — 高 -2ex, 低 -9ex, CLK↑后 tCQ=12pt 延迟
  \draw[BookTeal,line width=3pt]
    (0,-9ex) -- ++(32pt,0) -- ++(0,7ex) -- ++(64pt,0) -- ++(0,-7ex) -- ++(64pt,0)
             -- ++(0,7ex) -- ++(64pt,0) -- ++(0,-7ex) -- ++(36pt,0);
  \node[BookTeal,left] at (0,-5.5ex) {Q};
  % Setup/hold 窗口 — 填充矩形标注
...
\begin{waveform}[x=2pt,y=6ex]
  ...
  \draw[BookAccent,line width=3pt]
    (0,26ex) -- ++(32pt,0) -- ++(0,-6ex) -- ++(32pt,0) -- ++(0,6ex)
             ...
             -- ++(20pt,0);
  \node[BookAccent,left] at (0,23ex) {CLK};
  % D — 高 13ex, 低 5ex, CLK↑前 12pt 建立
  \draw[BookAmber,line width=3pt]
    (0,5ex) -- ++(20pt,0) -- ++(0,8ex) -- ++(52pt,0) -- ++(0,-8ex) -- ++(188pt,0);
  \node[BookAmber,left] at (0,9ex) {D};
  % Q — 高 -2ex, 低 -9ex, CLK↑后 tCQ=12pt 才变化
  \draw[BookTeal,line width=3pt]
    (0,-9ex) -- ++(44pt,0) -- ++(0,7ex) -- ++(64pt,0) -- ++(0,-7ex) -- ++(152pt,0);
  \node[BookTeal,left] at (0,-5.5ex) {Q};
  % 测量标注
  \draw[BookRed,line width=1.2pt,<->]
    (32pt,17ex) -- node[above=1pt,font=\scriptsize\bfseries,BookRed]{\code{tCQ}} (44pt,17ex);
  \draw[BookAmber,line width=1.2pt,<->]
    (44pt,17ex) -- node[above=1pt,font=\scriptsize\bfseries,BookAmber]{组合逻辑延迟} (96pt,17ex);
  \draw[BookTeal,line width=1.2pt,<->]
    (96pt,17ex) -- node[above=1pt,font=\scriptsize\bfseries,BookTeal]{\code{tSU}} (108pt,17ex);
\end{waveform}
...
\begin{waveform}[x=2pt,y=6ex]
  ...
  % CLK
  \draw[BookAccent,line width=3pt]
    (0,28ex) -- ++(32pt,0) -- ++(0,-6ex) -- ++(32pt,0) -- ++(0,6ex)
             -- ++(32pt,0) -- ++(0,-6ex) -- ++(32pt,0) -- ++(0,6ex)
             -- ++(32pt,0) -- ++(0,-6ex) -- ++(32pt,0) -- ++(0,6ex)
             -- ++(32pt,0) -- ++(0,-6ex) -- ++(32pt,0) -- ++(0,6ex)
             -- ++(20pt,0);
  ...
  % Async input
  \draw[BookAmber,line width=3pt]
    (0,11ex) -- ++(80pt,0) -- ++(0,6ex) -- ++(120pt,0) -- ++(0,-6ex) -- ++(60pt,0);
  \node[BookAmber,left] at (0,14ex) {async input};
  % FF1 — 有亚稳态振荡
  \draw[BookRed,line width=3pt]
    (0,-2ex) -- ++(32pt,0) -- ++(0,8ex) -- ++(48pt,0);
  \draw[BookRed,dashed,line width=3pt]
    (80pt,6ex) .. controls (92pt,10ex) and (108pt,0ex) .. (120pt,4ex);
  \draw[BookRed,line width=3pt]
    (120pt,4ex) -- ++(40pt,0) -- ++(0,-6ex) -- ++(40pt,0);
  \draw[BookRed,dashed,line width=3pt]
    (200pt,-2ex) .. controls (212pt,3ex) and (228pt,10ex) .. (240pt,4ex);
  \draw[BookRed,line width=3pt] (240pt,4ex) -- ++(20pt,0);
  \node[BookRed,left] at (0,2ex) {FF$_1$ (meta)};
  % FF2 — 稳定同步输出
  \draw[BookTeal,line width=3pt]
    (0,-14ex) -- ++(120pt,0) -- ++(0,6ex) -- ++(120pt,0) -- ++(0,-6ex) -- ++(20pt,0);
