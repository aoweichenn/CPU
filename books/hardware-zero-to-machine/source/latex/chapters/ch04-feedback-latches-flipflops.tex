...
\end{lstlisting}
\vspace{3.0em plus 1.0em}
\begin{waveform}[x=1.2pt,y=1.5ex]
  \draw[BookRule!30,step=24pt] (0,-3ex) grid (320pt,9ex);
  \draw[BookAccent,very thick] (0,5ex) -- (0,7ex) -- (24pt,7ex) -- (24pt,5ex) -- (48pt,5ex) -- (48pt,7ex) -- (72pt,7ex) -- (72pt,5ex) -- (96pt,5ex) -- (96pt,7ex) -- (120pt,7ex) -- (120pt,5ex) -- (144pt,5ex) -- (144pt,7ex) -- (168pt,7ex) -- (168pt,5ex) -- (192pt,5ex) -- (192pt,7ex) -- (216pt,7ex) -- (216pt,5ex) -- (240pt,5ex) -- (240pt,7ex) -- (264pt,7ex) -- (264pt,5ex) -- (288pt,5ex) -- (288pt,7ex) -- (312pt,7ex) -- (312pt,5ex) -- (320pt,5ex);
  \node[BookAccent,left] at (0,6ex) {CLK};
  \draw[BookAmber,very thick] (0,0) -- (16pt,0) -- (16pt,3.5ex) -- (56pt,3.5ex) -- (56pt,0) -- (100pt,0) -- (100pt,3.5ex) -- (148pt,3.5ex) -- (148pt,0) -- (196pt,0) -- (196pt,3.5ex) -- (244pt,3.5ex) -- (244pt,0) -- (292pt,0) -- (292pt,3.5ex) -- (320pt,3.5ex);
  \node[BookAmber,left] at (0,1.75ex) {D};
  \draw[BookTeal,very thick] (0,-3ex) -- (24pt,-3ex) -- (24pt,0) -- (72pt,0) -- (72pt,-3ex) -- (120pt,-3ex) -- (120pt,0) -- (168pt,0) -- (168pt,-3ex) -- (216pt,-3ex) -- (216pt,0) -- (264pt,0) -- (264pt,-3ex) -- (312pt,-3ex) -- (312pt,0) -- (320pt,0);
  \node[BookTeal,left] at (0,-1.5ex) {Q};
  \foreach \x in {16,64,112,160,208,256,304} {\fill[BookRed!18] (\x pt,5.3ex) rectangle (\x+8 pt,7.3ex);}
  \foreach \x in {24,72,120,168,216,264,312} {\fill[BookAmber!18] (\x pt,5.3ex) rectangle (\x+8 pt,7.3ex);}
  \node[BookRed,right,font=\small] at (24pt,8.5ex) {建立窗口 $t_{su}$};
  \node[BookAmber,right,font=\small] at (32pt,8.5ex) {保持窗口 $t_h$};
\end{waveform}
...
\begin{waveform}[x=1.2pt,y=1.5ex]
  ...
  \draw[BookAccent,very thick] (0,5ex) -- (0,7ex) -- (24pt,7ex) -- (24pt,5ex) -- (48pt,5ex) -- (48pt,7ex) -- (72pt,7ex) -- (72pt,5ex) -- (96pt,5ex) -- (96pt,7ex) -- (120pt,7ex) -- (120pt,5ex) -- (144pt,5ex) -- (144pt,7ex) -- (168pt,7ex) -- (168pt,5ex) -- (192pt,5ex) -- (192pt,7ex) -- (216pt,7ex) -- (216pt,5ex) -- (240pt,5ex) -- (240pt,7ex) -- (264pt,7ex) -- (264pt,5ex) -- (288pt,5ex) -- (288pt,7ex) -- (312pt,7ex) -- (312pt,5ex) -- (320pt,5ex);
  \node[BookAccent,left] at (0,6ex) {CLK};
  \draw[BookAmber,very thick] (0,0) -- (16pt,0) -- (16pt,3.5ex) -- (56pt,3.5ex) -- (56pt,0) -- (320pt,0);
  \node[BookAmber,left] at (0,1.75ex) {D};
  \draw[BookTeal,very thick] (0,-3ex) -- (24pt,-3ex) -- (34pt,-3ex) -- (34pt,0) -- (84pt,0) -- (84pt,-3ex) -- (320pt,-3ex);
  \node[BookTeal,left] at (0,-1.5ex) {Q};
  \draw[BookRed,very thick,->] (24pt,-4.5ex) -- (34pt,-4.5ex) node[below,font=\small,BookRed,midway] {\code{tCQ}};
  \draw[BookAmber,very thick,->] (34pt,4.5ex) -- (72pt,4.5ex) node[above,font=\small,BookAmber,midway] {组合逻辑延迟};
  \draw[BookTeal,very thick,->] (72pt,4.5ex) -- (84pt,4.5ex) node[above,font=\small,BookTeal,midway] {\code{tSU}};
\end{waveform}
...
\vspace{3.0em plus 1.0em}
\begin{waveform}[x=1.2pt,y=1.5ex]
  \draw[BookRule!30,step=24pt] (0,-5ex) grid (320pt,9ex);
  \draw[BookAccent,very thick] (0,5ex) -- (0,7ex) -- (24pt,7ex) -- (24pt,5ex) -- (48pt,5ex) -- (48pt,7ex) -- (72pt,7ex) -- (72pt,5ex) -- (96pt,5ex) -- (96pt,7ex) -- (120pt,7ex) -- (120pt,5ex) -- (144pt,5ex) -- (144pt,7ex) -- (168pt,7ex) -- (168pt,5ex) -- (192pt,5ex) -- (192pt,7ex) -- (216pt,7ex) -- (216pt,5ex) -- (240pt,5ex) -- (240pt,7ex) -- (264pt,7ex) -- (264pt,5ex) -- (288pt,5ex) -- (288pt,7ex) -- (312pt,7ex) -- (312pt,5ex) -- (320pt,5ex);
  \node[BookAccent,left] at (0,6ex) {CLK};
  \draw[BookAmber,very thick] (0,0) -- (60pt,0) -- (60pt,3.5ex) -- (180pt,3.5ex) -- (180pt,0) -- (320pt,0);
  \node[BookAmber,left] at (0,1.75ex) {async input};
  \draw[BookRed,very thick] (0,-3ex) -- (24pt,-3ex) -- (24pt,0) -- (60pt,0);
  \draw[BookRed,dashed,very thick] (60pt,0) .. controls (68pt,2.5ex) and (76pt,-2.5ex) .. (84pt,0);
  \draw[BookRed,very thick] (84pt,0) -- (120pt,0) -- (120pt,-3ex) -- (180pt,-3ex);
  \draw[BookRed,dashed,very thick] (180pt,-3ex) .. controls (188pt,-0.5ex) and (196pt,2.5ex) .. (204pt,0);
  \draw[BookRed,very thick] (204pt,0) -- (320pt,0);
  \node[BookRed,left] at (0,-1.5ex) {FF$_1$ (meta)};
  \draw[BookTeal,very thick] (0,-6ex) -- (84pt,-6ex) -- (84pt,-3ex) -- (204pt,-3ex) -- (204pt,-6ex) -- (320pt,-6ex);
  \node[BookTeal,left] at (0,-4.5ex) {FF$_2$ (sync)};
  \node[BookRed,font=\small] at (72pt,5ex) {亚稳态};
  \node[BookTeal,font=\small] at (144pt,-5.5ex) {稳定输出};
\end{waveform}
