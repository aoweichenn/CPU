...
\begin{waveform}[x=2pt,y=5ex]
  ...
  \node[BookTeal,left,font=\normalsize] at (0,-6ex) {Q};
  % Arrows with labels — 放在 CLK 和 D 之间的空隙 (18ex 位置)
  \draw[BookRed,line width=2.5pt,->] (32pt,18ex) -- (44pt,18ex) node[above,font=\small\bfseries,BookRed,midway] {\code{tCQ}};
  \draw[BookAmber,line width=2.5pt,->] (44pt,18ex) -- (96pt,18ex) node[above,font=\small\bfseries,BookAmber,midway] {组合逻辑延迟};
  \draw[BookTeal,line width=2.5pt,->] (96pt,18ex) -- (108pt,18ex) node[above,font=\small\bfseries,BookTeal,midway] {\code{tSU}};
\end{waveform}
\diagramnote{\code{tCQ} + 组合逻辑延迟 + \code{tSU} = 最小时钟周期。}
