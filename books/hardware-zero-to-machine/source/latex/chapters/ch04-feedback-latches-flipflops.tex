...
\begin{circuit}[x=2.4cm,y=1.8cm]
  \node[not gate US, draw, scale=1.4] (inv1) at (0,0) {};
  \node[not gate US, draw, scale=1.4] (inv2) at (4.5,0) {};
  \node[left] at ($(inv1.input)+(-0.9,0)$) {X};
  \node[right] at ($(inv2.output)+(0.9,0)$) {Y};
  \draw (inv1.output) -- ++(0.6,0) |- ($(inv2.input)+(-0.5,0)$) -- (inv2.input);
  \draw (inv2.output) -- ++(0.6,0) |- ($(inv1.input)+(-0.5,0)$) -- (inv1.input);
  \node[below=0.6cm of inv1, font=\small, BookTeal] {稳定状态 0};
  \node[below=0.6cm of inv2, font=\small, BookTeal] {稳定状态 1};
\end{circuit}
...
\end{longtable}
\vspace{3.0em plus 1.0em}
\begin{circuit}[x=2.2cm,y=1.8cm]
  \node[nand gate US, draw, logic gate inputs=nn, scale=1.4] (n1) at (0,0) {};
  \node[nand gate US, draw, logic gate inputs=nn, scale=1.4] (n2) at (5.5,0) {};
  \node[left] at ($(n1.input 1)+(-1.1,0)$) {$\overline{S}$ (Set)};
  \node[left] at ($(n1.input 2)+(-1.1,0)$) {$\overline{R}$ (Reset)};
  \node[right, font=\small] at ($(n1.output)+(1.0,0.2)$) {Q};
  \node[right, font=\small] at ($(n2.output)+(1.0,0.2)$) {$\overline{Q}$};
  \draw ($(n1.input 1)+(-1.1,0)$) -- (n1.input 1);
  \draw ($(n1.input 2)+(-1.1,0)$) -- (n1.input 2);
  \draw (n1.output) -- ++(0.9,0) |- ($(n2.input 1)+(-0.9,0)$) -- (n2.input 1);
  \draw (n2.output) -- ++(0.9,0) |- ($(n1.input 2)+(-0.9,0)$) -- (n1.input 2);
  \node[above=0.3cm of n1, font=\scriptsize, BookMuted] {NAND$_1$};
  \node[above=0.3cm of n2, font=\scriptsize, BookMuted] {NAND$_2$};
\end{circuit}
...
\begin{waveform}[x=2pt,y=5ex]
  \draw[BookRule!20,step=20pt] (0,-14ex) grid (300pt,36ex);
  % CLK at top — 高:30ex, 低:22ex
  \draw[BookAccent,line width=3pt] (0,22ex) -- (0,30ex) -- (32pt,30ex) -- (32pt,22ex) -- (64pt,22ex) -- (64pt,30ex) -- (96pt,30ex) -- (96pt,22ex) -- (128pt,22ex) -- (128pt,30ex) -- (160pt,30ex) -- (160pt,22ex) -- (192pt,22ex) -- (192pt,30ex) -- (224pt,30ex) -- (224pt,22ex) -- (256pt,22ex) -- (256pt,30ex) -- (280pt,30ex) -- (280pt,22ex) -- (300pt,22ex);
  \node[BookAccent,left,font=\normalsize] at (0,26ex) {CLK};
  % D in middle — 高:14ex, 低:6ex
  \draw[BookAmber,line width=3pt] (0,6ex) -- (20pt,6ex) -- (20pt,14ex) -- (72pt,14ex) -- (72pt,6ex) -- (128pt,6ex) -- (128pt,14ex) -- (176pt,14ex) -- (176pt,6ex) -- (224pt,6ex) -- (224pt,14ex) -- (272pt,14ex) -- (272pt,6ex) -- (300pt,6ex);
  \node[BookAmber,left,font=\normalsize] at (0,10ex) {D};
  % Q at bottom — 高:-2ex, 低:-10ex
  \draw[BookTeal,line width=3pt] (0,-10ex) -- (32pt,-10ex) -- (32pt,-2ex) -- (96pt,-2ex) -- (96pt,-10ex) -- (160pt,-10ex) -- (160pt,-2ex) -- (224pt,-2ex) -- (224pt,-10ex) -- (280pt,-10ex) -- (280pt,-2ex) -- (300pt,-2ex);
  \node[BookTeal,left,font=\normalsize] at (0,-6ex) {Q};
  % Setup/hold windows — 靠近 CLK 边沿
  \foreach \x in {20,76,132,188,244} {\fill[BookRed!25] (\x pt,21.5ex) rectangle (\x+12 pt,30.5ex);}
  \foreach \x in {32,96,160,224,280} {\fill[BookAmber!25] (\x pt,21.5ex) rectangle (\x+12 pt,30.5ex);}
  \node[BookRed,right,font=\small] at (32pt,33ex) {\code{t_{su}}};
  \node[BookAmber,right,font=\small] at (44pt,33ex) {\code{t_h}};
\end{waveform}
...
\end{longtable}
\vspace{3.0em plus 1.0em}
\begin{block}[x=1.6cm,y=1.5cm]
  \node[hw compute, minimum width=2.4cm] (tcq) {tCQ};
  \node[hw compute, right=0.7cm of tcq, minimum width=3.6cm] (tcomb) {组合逻辑};
  \node[hw compute, right=0.7cm of tcomb, minimum width=2.2cm] (twire) {连线};
  \node[hw compute, right=0.7cm of twire, minimum width=2.0cm] (tsu) {tSU};
  \node[hw compute, right=0.7cm of tsu, minimum width=1.8cm] (tskew) {偏斜+余量};
  \node[hw label, below=0.35cm of tcq] {0.8ns};
  \node[hw label, below=0.35cm of tcomb] {3.6ns};
  \node[hw label, below=0.35cm of twire] {0.7ns};
  \node[hw label, below=0.35cm of tsu] {0.4ns};
  \node[hw label, below=0.35cm of tskew] {0.5ns};
  \draw[hw bus] (tcq.west) -- ++(-0.8,0) node[left,hw label]{CLK};
  \draw[hw bus] (tskew.east) -- ++(0.8,0) node[right,hw label]{CLK};
  \draw[BookMuted, decorate, decoration={brace,amplitude=5pt,raise=3pt}] (tcq.north west) -- (tskew.north east) node[midway,above=14pt,BookAccent,font=\small] {Tclk $\geq$ 6.0ns};
\end{block}
...
\begin{waveform}[x=2pt,y=5ex]
  ...
  \node[BookAccent,left,font=\normalsize] at (0,26ex) {CLK};
  % D in middle — 高:14ex, 低:6ex
  \draw[BookAmber,line width=3pt] (0,6ex) -- (20pt,6ex) -- (20pt,14ex) -- (72pt,14ex) -- (72pt,6ex) -- (300pt,6ex);
  \node[BookAmber,left,font=\normalsize] at (0,10ex) {D};
  % Q at bottom — 高:-2ex, 低:-10ex
  \draw[BookTeal,line width=3pt] (0,-10ex) -- (32pt,-10ex) -- (44pt,-10ex) -- (44pt,-2ex) -- (108pt,-2ex) -- (108pt,-10ex) -- (300pt,-10ex);
  \node[BookTeal,left,font=\normalsize] at (0,-6ex) {Q};
  % 右侧图例：三个时间段上下排列
  \draw[BookRed,line width=2.5pt,->] (280pt,28ex) -- (295pt,28ex) node[right,font=\small\bfseries,BookRed] {\code{tCQ}};
  \draw[BookAmber,line width=2.5pt,->] (280pt,18ex) -- (295pt,18ex) node[right,font=\small\bfseries,BookAmber] {组合逻辑延迟};
  \draw[BookTeal,line width=2.5pt,->] (280pt,8ex) -- (295pt,8ex) node[right,font=\small\bfseries,BookTeal] {\code{tSU}};
  % 波形上的标注箭头（保留以指示测量起点/终点）
  \draw[BookRed,line width=1.2pt,<->] (32pt,21ex) -- (44pt,21ex);
  \draw[BookAmber,line width=1.2pt,<->] (44pt,21ex) -- (96pt,21ex);
  \draw[BookTeal,line width=1.2pt,<->] (96pt,21ex) -- (108pt,21ex);
\end{waveform}
...
\begin{block}[x=1.8cm,y=1.2cm]
  ...
  \node[below=0.2cm of latch, hw label] {STCP 锁存};
\end{block}
...
\begin{waveform}[x=2pt,y=5ex]
  \draw[BookRule!20,step=20pt] (0,-24ex) grid (300pt,42ex);
  % CLK at top — 高:36ex, 低:28ex
  \draw[BookAccent,line width=3pt] (0,28ex) -- (0,36ex) -- (32pt,36ex) -- (32pt,28ex) -- (64pt,28ex) -- (64pt,36ex) -- (96pt,36ex) -- (96pt,28ex) -- (128pt,28ex) -- (128pt,36ex) -- (160pt,36ex) -- (160pt,28ex) -- (192pt,28ex) -- (192pt,36ex) -- (224pt,36ex) -- (224pt,28ex) -- (256pt,28ex) -- (256pt,36ex) -- (280pt,36ex) -- (280pt,28ex) -- (300pt,28ex);
  \node[BookAccent,left,font=\normalsize] at (0,32ex) {CLK};
  % Async input — 高:22ex, 低:14ex
  \draw[BookAmber,line width=3pt] (0,14ex) -- (80pt,14ex) -- (80pt,22ex) -- (200pt,22ex) -- (200pt,14ex) -- (300pt,14ex);
  \node[BookAmber,left,font=\normalsize] at (0,18ex) {async input};
  % FF1 output — 有亚稳态振荡, 高:8ex, 低:-2ex
  \draw[BookRed,line width=3pt] (0,-2ex) -- (32pt,-2ex) -- (32pt,8ex) -- (80pt,8ex);
  \draw[BookRed,dashed,line width=3pt] (80pt,8ex) .. controls (92pt,13ex) and (108pt,1ex) .. (120pt,6ex);
  \draw[BookRed,line width=3pt] (120pt,6ex) -- (160pt,6ex) -- (160pt,-2ex) -- (200pt,-2ex);
  \draw[BookRed,dashed,line width=3pt] (200pt,-2ex) .. controls (212pt,5ex) and (228pt,13ex) .. (240pt,6ex);
  \draw[BookRed,line width=3pt] (240pt,6ex) -- (300pt,6ex);
  \node[BookRed,left,font=\normalsize] at (0,3ex) {FF$_1$ (meta)};
  % FF2 output — 稳定, 高:-10ex, 低:-18ex
  \draw[BookTeal,line width=3pt] (0,-18ex) -- (120pt,-18ex) -- (120pt,-10ex) -- (240pt,-10ex) -- (240pt,-18ex) -- (300pt,-18ex);
  \node[BookTeal,left,font=\normalsize] at (0,-14ex) {FF$_2$ (sync)};
  % Annotations
  \node[BookRed,font=\small,align=center] at (100pt,40ex) {亚稳态};
  \node[BookTeal,font=\small\bfseries] at (160pt,-22ex) {稳定输出};
\end{waveform}
...
\begin{block}[x=1.8cm,y=1.5cm]
  \node[draw, circle, minimum size=1.6cm, fill=BookCodeBg] (idle) {IDLE};
  \node[draw, circle, minimum size=1.6cm, fill=BookCodeBg, right=2.8cm of idle] (load) {LOAD};
  \node[draw, circle, minimum size=1.6cm, fill=BookCodeBg, right=2.8cm of load] (run) {RUN};
  \node[draw, circle, minimum size=1.6cm, fill=BookCodeBg, right=2.8cm of run] (done) {DONE};
  ...
  \draw[hw bus, bend left=55] (done) to node[below=0.8cm, hw label, pos=0.5]{clear=1} (idle);
  \draw[hw bus, bend right=45] (idle) to node[below, hw label]{start=0} (idle);
  \draw[hw bus, bend left=45] (done) to node[below, hw label]{clear=0} (done);
\end{block}
