...
\begin{circuit}[x=1.6cm,y=1.1cm]
  \node[nand gate US, draw, logic gate inputs=nn, scale=1.1] (nand1) at (0,0) {};
  \node[nand gate US, draw, logic gate inputs=nn, scale=1.1] (nand2) at (3.5,0) {};
  \node[left] at ($(nand1.input 1)+(-0.6,0)$) {$\overline{S}$};
  \node[left] at ($(nand1.input 2)+(-0.6,0)$) {$\overline{R}$};
  \node[right, font=\small\bfseries] at ($(nand1.output)+(0.4,0)$) {Q};
  \node[right, font=\small\bfseries] at ($(nand2.output)+(0.4,0)$) {$\overline{Q}$};
  \draw (nand1.output) -- ++(0.4,0) |- ($(nand2.input 1)+(-0.4,0)$) -- (nand2.input 1);
  \draw (nand2.output) -- ++(0.4,0) |- ($(nand1.input 2)+(-0.4,0)$) -- (nand1.input 2);
  \draw ($(nand1.input 1)+(-0.6,0)$) -- (nand1.input 1);
  \draw ($(nand1.input 2)+(-0.6,0)$) -- (nand1.input 2);
\end{circuit}
...
\begin{block}[x=1.5cm,y=1cm]
  \node[draw, rectangle, minimum width=1.6cm, minimum height=1.4cm, label=D] (dlatch) {};
  \node[left] at ($(dlatch.west)+(-0.1,0.3)$) {D};
  \node[left] at ($(dlatch.west)+(-0.1,-0.3)$) {E};
  \node[right] at ($(dlatch.east)+(0.1,0.3)$) {Q};
  \node[right] at ($(dlatch.east)+(0.1,-0.3)$) {Q'};
  \node[above] at (dlatch.north) {D-Latch};
\end{block}
\diagramnote{D 锁存器方框符号：E=1 时 Q 跟随 D（透明），E=0 时保持原值。}
...
\begin{waveform}[x=1pt,y=1.2ex]
  \draw[BookRule!30,step=24pt] (0,-3ex) grid (260pt,8ex);
  \draw[BookAccent,thick] (0,4ex) -- (0,6ex) -- (24pt,6ex) -- (24pt,4ex) -- (48pt,4ex) -- (48pt,6ex) -- (72pt,6ex) -- (72pt,4ex) -- (96pt,4ex) -- (96pt,6ex) -- (120pt,6ex) -- (120pt,4ex) -- (144pt,4ex) -- (144pt,6ex) -- (168pt,6ex) -- (168pt,4ex) -- (192pt,4ex) -- (192pt,6ex) -- (216pt,6ex) -- (216pt,4ex) -- (240pt,4ex) -- (240pt,6ex) -- (260pt,6ex);
  \node[BookAccent,left] at (0,5ex) {CLK};
  \draw[BookAmber,thick] (0,0) -- (18pt,0) -- (18pt,3ex) -- (54pt,3ex) -- (54pt,0) -- (90pt,0) -- (90pt,3ex) -- (132pt,3ex) -- (132pt,0) -- (174pt,0) -- (174pt,3ex) -- (210pt,3ex) -- (210pt,0) -- (260pt,0);
  \node[BookAmber,left] at (0,1.5ex) {D};
  \draw[BookTeal,thick] (0,-3ex) -- (24pt,-3ex) -- (24pt,0) -- (72pt,0) -- (72pt,-3ex) -- (120pt,-3ex) -- (120pt,0) -- (168pt,0) -- (168pt,-3ex) -- (216pt,-3ex) -- (216pt,0) -- (260pt,0);
  \node[BookTeal,left] at (0,-1.5ex) {Q};
  \fill[BookRed!12] (18pt,4.5ex) rectangle (24pt,6.5ex);
  \fill[BookRed!12] (42pt,4.5ex) rectangle (48pt,6.5ex);
  \fill[BookRed!12] (66pt,4.5ex) rectangle (72pt,6.5ex);
  \fill[BookRed!12] (90pt,4.5ex) rectangle (96pt,6.5ex);
  \fill[BookRed!12] (114pt,4.5ex) rectangle (120pt,6.5ex);
  \fill[BookRed!12] (138pt,4.5ex) rectangle (144pt,6.5ex);
  \fill[BookRed!12] (162pt,4.5ex) rectangle (168pt,6.5ex);
  \fill[BookRed!12] (186pt,4.5ex) rectangle (192pt,6.5ex);
  \fill[BookRed!12] (210pt,4.5ex) rectangle (216pt,6.5ex);
  \fill[BookAmber!12] (24pt,4.5ex) rectangle (30pt,6.5ex);
  \fill[BookAmber!12] (48pt,4.5ex) rectangle (54pt,6.5ex);
  \fill[BookAmber!12] (72pt,4.5ex) rectangle (78pt,6.5ex);
  \fill[BookAmber!12] (96pt,4.5ex) rectangle (102pt,6.5ex);
  \fill[BookAmber!12] (120pt,4.5ex) rectangle (126pt,6.5ex);
  \fill[BookAmber!12] (144pt,4.5ex) rectangle (150pt,6.5ex);
  \fill[BookAmber!12] (168pt,4.5ex) rectangle (174pt,6.5ex);
  \fill[BookAmber!12] (192pt,4.5ex) rectangle (198pt,6.5ex);
  \fill[BookAmber!12] (216pt,4.5ex) rectangle (222pt,6.5ex);
  \node[BookRed,right,font=\scriptsize] at (24pt,7.5ex) {建立窗口};
  \node[BookAmber,right,font=\scriptsize] at (30pt,7.5ex) {保持窗口};
  \draw[BookRed,thick,dashed] (120pt,0) -- (120pt,3ex) -- (126pt,3ex);
  \node[BookRed,below right,font=\scriptsize] at (120pt,-0.5ex) {D 变化};
\end{waveform}
\diagramnote{建立/保持时间窗口。D 必须在时钟沿前后保持稳定；阴影区表示 D 不允许变化的窗口。}
...
\begin{block}[x=1.5cm,y=0.7cm]
  \node[hw compute, minimum width=2.2cm] (tcq) {tCQ};
  \node[hw compute, right=0.4cm of tcq, minimum width=3.2cm] (tcomb) {组合逻辑};
  \node[hw compute, right=0.4cm of tcomb, minimum width=1.6cm] (twire) {连线};
  \node[hw compute, right=0.4cm of twire, minimum width=1.4cm] (tsu) {tSU};
  \node[hw compute, right=0.4cm of tsu, minimum width=1.2cm] (tskew) {偏斜+余量};
  \node[hw label, below=0.1cm of tcq] {0.8ns};
  \node[hw label, below=0.1cm of tcomb] {3.6ns};
  \node[hw label, below=0.1cm of twire] {0.7ns};
  \node[hw label, below=0.1cm of tsu] {0.4ns};
  \node[hw label, below=0.1cm of tskew] {0.5ns};
  \draw[hw bus] (tcq.west) -- ++(-0.6,0) node[left,hw label]{CLK};
  \draw[hw bus] (tskew.east) -- ++(0.6,0) node[right,hw label]{CLK};
  \node[above=0.5cm of tcq, hw label] (sum) {周期 $\geq$ 6.0ns};
  \draw[BookMuted, decorate, decoration={brace,amplitude=4pt,raise=2pt}] (tcq.north west) -- (tskew.north east) node[midway,above=8pt,BookAccent,font=\small\bfseries] {Tclk};
\end{block}
\diagramnote{时钟周期预算：源触发器时钟到输出 + 组合逻辑 + 连线 + 建立时间 + 偏斜/余量。}
...
\begin{block}[x=1.5cm,y=0.9cm]
  ...
  \node[hw control, right=0.8cm of ff2] (ctrl) {同步复位};
  ...
  \node[below=0.15cm of ctrl, hw label] {到状态机};
\end{block}
\diagramnote{异步拉入、同步释放的复位电路：复位信号异步进入，经过两级触发器同步后，在时钟边界释放到状态机。}
...
\begin{block}[x=1.6cm,y=0.9cm]
  \node[draw, dashed, rounded corners, inner sep=6pt, minimum width=1.2cm, label={[hw label]above:异步输入域}] (async) {外部事件};
  \node[hw state, right=1.2cm of async, label={[hw label]above:第一级}] (ff1) {FF$_1$};
  \node[hw state, right=1.0cm of ff1, label={[hw label]above:第二级}] (ff2) {FF$_2$};
  \node[draw, dashed, rounded corners, inner sep=6pt, right=1.2cm of ff2, minimum width=1.4cm, label={[hw label]above:目标时钟域}] (sync) {同步后信号};
  \draw[hw bus] (async) -- (ff1) node[above,hw label,pos=0.5]{可能亚稳态};
  \draw[hw bus] (ff1) -- (ff2) node[above,hw label,pos=0.5]{恢复时间};
  \draw[hw bus] (ff2) -- (sync) node[above,hw label,pos=0.5]{稳定};
  \node[below=0.15cm of ff1, BookRed, font=\scriptsize] {meta};
  \node[below=0.15cm of ff2, BookTeal, font=\scriptsize] {sync};
\end{block}
\diagramnote{两级触发器同步器：第一级采样异步输入（可能进入亚稳态），第二级在下一个时钟沿再采样，给第一级留出恢复时间。}
...
\end{block}
\diagramnote{写使能寄存器：WE=0 时 MUX 选择旧 Q 反馈，WE=1 时选择新 D$_{in}$。时钟始终存在。}
...
\begin{block}[x=1.5cm,y=0.9cm]
  ...
  \draw[hw bus] (q) |- ++(0,0.8) -| (add.north) node[above right, hw label, pos=0.3]{当前值};
...
\end{block}
\diagramnote{4-bit 同步计数器：当前值经 +1 反馈到寄存器输入；EN 控制是否执行加一。}
...
\begin{block}[x=1.4cm,y=0.9cm]
  \node[hw state, minimum width=2.4cm, label={[hw label]above:8-bit 移位寄存器}] (shift) {};
  \node[hw memory, right=0.6cm of shift, minimum width=2.4cm, label={[hw label]above:8-bit 输出锁存}] (latch) {};
  ...
  \node[below=0.15cm of shift, hw label] {SHCP 移位};
  \node[below=0.15cm of latch, hw label] {STCP 锁存};
\end{block}
\diagramnote{74HC595：移位寄存器与输出锁存器分开，避免外部负载在移位过程中看到中间状态。}
...
\begin{block}[x=1.5cm,y=1.0cm]
  ...
  \node[right=0.6cm of out] (outputs) {控制输出};
  ...
  \draw[hw bus] (state) |- ++(0,-0.6) -| (out) node[below, hw label, pos=0.3]{当前状态};
\end{block}
\diagramnote{有限状态机结构：状态寄存器保存当前状态，组合逻辑计算下一状态和输出。}
...
\end{block}
\diagramnote{四状态硬件控制器状态图：IDLE → LOAD → RUN → DONE → IDLE。}
