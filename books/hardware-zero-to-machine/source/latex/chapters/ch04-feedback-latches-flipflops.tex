...
\begin{waveform}[x=1.2pt,y=1.5ex]
  ...
  \node[BookTeal,left] at (0,-1.5ex) {Q};
  \draw[BookRed,very thick,->] (24pt,-3.5ex) -- (34pt,-3.5ex) node[below,font=\small,BookRed,midway] {tCQ};
  \draw[BookAmber,very thick,->] (34pt,2ex) -- (72pt,2ex) node[above,font=\small,BookAmber,midway] {组合逻辑延迟};
  \draw[BookTeal,very thick,->] (72pt,2ex) -- (84pt,2ex) node[above,font=\small,BookTeal,midway] {tSU};
\end{waveform}
\diagramnote{tCQ + 组合逻辑延迟 + tSU = 最小时钟周期。}
