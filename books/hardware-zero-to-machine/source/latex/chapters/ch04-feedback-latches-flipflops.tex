...
\end{lstlisting}
\vspace{3.0em plus 1.0em}
\begin{waveform}[x=1.5pt,y=3ex]
  \draw[BookRule!25,step=24pt] (0,-5ex) grid (320pt,14ex);
  \draw[BookAccent,line width=2.5pt] (0,7ex) -- (0,10ex) -- (32pt,10ex) -- (32pt,7ex) -- (64pt,7ex) -- (64pt,10ex) -- (96pt,10ex) -- (96pt,7ex) -- (128pt,7ex) -- (128pt,10ex) -- (160pt,10ex) -- (160pt,7ex) -- (192pt,7ex) -- (192pt,10ex) -- (224pt,10ex) -- (224pt,7ex) -- (256pt,7ex) -- (256pt,10ex) -- (288pt,10ex) -- (288pt,7ex) -- (320pt,7ex);
  \node[BookAccent,left,font=\small] at (0,8.5ex) {CLK};
  \draw[BookAmber,line width=2.5pt] (0,0) -- (24pt,0) -- (24pt,3.5ex) -- (72pt,3.5ex) -- (72pt,0) -- (128pt,0) -- (128pt,3.5ex) -- (176pt,3.5ex) -- (176pt,0) -- (224pt,0) -- (224pt,3.5ex) -- (272pt,3.5ex) -- (272pt,0) -- (320pt,0);
  \node[BookAmber,left,font=\small] at (0,1.75ex) {D};
  \draw[BookTeal,line width=2.5pt] (0,-5ex) -- (32pt,-5ex) -- (32pt,0) -- (96pt,0) -- (96pt,-5ex) -- (160pt,-5ex) -- (160pt,0) -- (224pt,0) -- (224pt,-5ex) -- (288pt,-5ex) -- (288pt,0) -- (320pt,0);
  \node[BookTeal,left,font=\small] at (0,-2.5ex) {Q};
  \foreach \x in {24,80,136,192,248,304} {\fill[BookRed!20] (\x pt,7.3ex) rectangle (\x+8 pt,9.7ex);}
  \foreach \x in {32,96,160,224,288} {\fill[BookAmber!20] (\x pt,7.3ex) rectangle (\x+8 pt,9.7ex);}
  \node[BookRed,right,font=\small] at (32pt,12ex) {\code{t_{su}}};
  \node[BookAmber,right,font=\small] at (40pt,12ex) {\code{t_h}};
\end{waveform}
...
\begin{waveform}[x=1.5pt,y=3ex]
  ...
  \draw[BookAccent,line width=2.5pt] (0,7ex) -- (0,10ex) -- (32pt,10ex) -- (32pt,7ex) -- (64pt,7ex) -- (64pt,10ex) -- (96pt,10ex) -- (96pt,7ex) -- (128pt,7ex) -- (128pt,10ex) -- (160pt,10ex) -- (160pt,7ex) -- (192pt,7ex) -- (192pt,10ex) -- (224pt,10ex) -- (224pt,7ex) -- (256pt,7ex) -- (256pt,10ex) -- (288pt,10ex) -- (288pt,7ex) -- (320pt,7ex);
  \node[BookAccent,left,font=\small] at (0,8.5ex) {CLK};
  \draw[BookAmber,line width=2.5pt] (0,0) -- (24pt,0) -- (24pt,3.5ex) -- (72pt,3.5ex) -- (72pt,0) -- (320pt,0);
  \node[BookAmber,left,font=\small] at (0,1.75ex) {D};
  \draw[BookTeal,line width=2.5pt] (0,-5ex) -- (32pt,-5ex) -- (44pt,-5ex) -- (44pt,0) -- (108pt,0) -- (108pt,-5ex) -- (320pt,-5ex);
  \node[BookTeal,left,font=\small] at (0,-2.5ex) {Q};
  \draw[BookRed,line width=2pt,->] (32pt,-6ex) -- (44pt,-6ex) node[below,font=\small,BookRed,midway] {\code{tCQ}};
  \draw[BookAmber,line width=2pt,->] (44pt,5ex) -- (96pt,5ex) node[above,font=\small,BookAmber,midway] {组合逻辑延迟};
  \draw[BookTeal,line width=2pt,->] (96pt,5ex) -- (108pt,5ex) node[above,font=\small,BookTeal,midway] {\code{tSU}};
\end{waveform}
...
\vspace{3.0em plus 1.0em}
\begin{waveform}[x=1.5pt,y=3ex]
  \draw[BookRule!25,step=24pt] (0,-8ex) grid (320pt,14ex);
  \draw[BookAccent,line width=2.5pt] (0,7ex) -- (0,10ex) -- (32pt,10ex) -- (32pt,7ex) -- (64pt,7ex) -- (64pt,10ex) -- (96pt,10ex) -- (96pt,7ex) -- (128pt,7ex) -- (128pt,10ex) -- (160pt,10ex) -- (160pt,7ex) -- (192pt,7ex) -- (192pt,10ex) -- (224pt,10ex) -- (224pt,7ex) -- (256pt,7ex) -- (256pt,10ex) -- (288pt,10ex) -- (288pt,7ex) -- (320pt,7ex);
  \node[BookAccent,left,font=\small] at (0,8.5ex) {CLK};
  \draw[BookAmber,line width=2.5pt] (0,0) -- (80pt,0) -- (80pt,3.5ex) -- (200pt,3.5ex) -- (200pt,0) -- (320pt,0);
  \node[BookAmber,left,font=\small] at (0,1.75ex) {async input};
  \draw[BookRed,line width=2.5pt] (0,-5ex) -- (32pt,-5ex) -- (32pt,0) -- (80pt,0);
  \draw[BookRed,dashed,line width=2.5pt] (80pt,0) .. controls (92pt,4ex) and (108pt,-4ex) .. (120pt,0);
  \draw[BookRed,line width=2.5pt] (120pt,0) -- (160pt,0) -- (160pt,-5ex) -- (200pt,-5ex);
  \draw[BookRed,dashed,line width=2.5pt] (200pt,-5ex) .. controls (212pt,-1ex) and (228pt,4ex) .. (240pt,0);
  \draw[BookRed,line width=2.5pt] (240pt,0) -- (320pt,0);
  \node[BookRed,left,font=\small] at (0,-2.5ex) {FF$_1$ (meta)};
  \draw[BookTeal,line width=2.5pt] (0,-10ex) -- (120pt,-10ex) -- (120pt,-5ex) -- (240pt,-5ex) -- (240pt,-10ex) -- (320pt,-10ex);
  \node[BookTeal,left,font=\small] at (0,-7.5ex) {FF$_2$ (sync)};
  \node[BookRed,font=\small,align=center ] at (100pt,12ex) {亚稳态};
  \node[BookTeal,font=\small] at (180pt,-9ex) {稳定输出};
\end{waveform}
