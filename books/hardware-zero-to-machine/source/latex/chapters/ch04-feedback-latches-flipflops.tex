...
\begin{block}[x=1.8cm,y=1.5cm]
  ...
  \draw[hw bus] (idle.south) .. controls +(-0.75,-0.95) and +(0.75,-0.95) .. node[below, hw label]{start=0} (idle.south east);
  \draw[hw bus] (done.south) .. controls +(-0.75,-0.95) and +(0.75,-0.95) .. node[below, hw label]{clear=0} (done.south east);
\end{block}
