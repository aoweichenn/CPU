...
\end{longtable}
\vspace{3.0em plus 1.0em}
\begin{circuit}[x=2.0cm,y=1.8cm]
  \node[nand gate US, draw, logic gate inputs=nn, scale=1.3] (n1) at (0,0) {};
  \node[nand gate US, draw, logic gate inputs=nn, scale=1.3] (n2) at (5,0) {};
  % 外部输入
  \node[left] at ($(n1.input 1)+(-0.8,0)$) {$\overline{S}$};
  \node[left] at ($(n2.input 1)+(-0.8,0)$) {$\overline{R}$};
  % 输出标签 — 放在输出端上方避免碰线
  \node[above=0.35cm of n1.output, font=\small, BookTeal] {Q};
  \node[above=0.35cm of n2.output, font=\small, BookTeal] {$\overline{Q}$};
  % 输入连线
  \draw ($(n1.input 1)+(-0.8,0)$) -- (n1.input 1);
  \draw ($(n2.input 1)+(-0.8,0)$) -- (n2.input 1);
  % 交叉耦合 — 走下方弧线，不遮挡标签
  \draw (n1.output) -- ++(0.5,0) |- ($(n2.input 2)+(-0.5,0)$) -- (n2.input 2);
  \draw (n2.output) -- ++(0.5,0) |- ($(n1.input 2)+(-0.5,0)$) -- (n1.input 2);
  % 门标注
  \node[above=0.25cm of n1, font=\scriptsize, BookMuted] {NAND$_1$};
  \node[above=0.25cm of n2, font=\scriptsize, BookMuted] {NAND$_2$};
\end{circuit}
...
\begin{waveform}[x=2pt,y=6ex]
  \draw[BookRule!20,step=20pt] (0,-12ex) grid (260pt,30ex);
  % CLK — 高:26ex, 低:20ex
  \draw[BookAccent,line width=3pt] (0,20ex) -- (0,26ex) -- (32pt,26ex) -- (32pt,20ex) -- (64pt,20ex) -- (64pt,26ex) -- (96pt,26ex) -- (96pt,20ex) -- (128pt,20ex) -- (128pt,26ex) -- (160pt,26ex) -- (160pt,20ex) -- (192pt,20ex) -- (192pt,26ex) -- (224pt,26ex) -- (224pt,20ex) -- (256pt,20ex) -- (256pt,26ex) -- (260pt,26ex);
  \node[BookAccent,left,font=\normalsize] at (0,23ex) {CLK};
  % D — 高:13ex, 低:5ex
  \draw[BookAmber,line width=3pt] (0,5ex) -- (20pt,5ex) -- (20pt,13ex) -- (72pt,13ex) -- (72pt,5ex) -- (128pt,5ex) -- (128pt,13ex) -- (176pt,13ex) -- (176pt,5ex) -- (224pt,5ex) -- (224pt,13ex) -- (260pt,13ex);
  \node[BookAmber,left,font=\normalsize] at (0,9ex) {D};
  % Q — 高:-2ex, 低:-9ex
  \draw[BookTeal,line width=3pt] (0,-9ex) -- (32pt,-9ex) -- (32pt,-2ex) -- (96pt,-2ex) -- (96pt,-9ex) -- (160pt,-9ex) -- (160pt,-2ex) -- (224pt,-2ex) -- (224pt,-9ex) -- (260pt,-9ex);
  \node[BookTeal,left,font=\normalsize] at (0,-5.5ex) {Q};
  % Setup/hold 窗口
  \foreach \x in {20,76,132,188} {\fill[BookRed!25] (\x pt,19.5ex) rectangle (\x+12 pt,26.5ex);}
  \foreach \x in {32,96,160,224} {\fill[BookAmber!25] (\x pt,19.5ex) rectangle (\x+12 pt,26.5ex);}
  \node[BookRed,right,font=\small] at (32pt,28ex) {\code{t_{su}}};
  \node[BookAmber,right,font=\small] at (44pt,28ex) {\code{t_h}};
\end{waveform}
...
\begin{waveform}[x=2pt,y=6ex]
  ...
  \node[BookAccent,left,font=\normalsize] at (0,23ex) {CLK};
  % D — 高:13ex, 低:5ex
  \draw[BookAmber,line width=3pt] (0,5ex) -- (20pt,5ex) -- (20pt,13ex) -- (72pt,13ex) -- (72pt,5ex) -- (260pt,5ex);
  \node[BookAmber,left,font=\normalsize] at (0,9ex) {D};
  % Q — 高:-2ex, 低:-9ex, tCQ 延迟从 32pt→44pt
  \draw[BookTeal,line width=3pt] (0,-9ex) -- (32pt,-9ex) -- (44pt,-9ex) -- (44pt,-2ex) -- (108pt,-2ex) -- (108pt,-9ex) -- (260pt,-9ex);
  \node[BookTeal,left,font=\normalsize] at (0,-5.5ex) {Q};
  % 波形上 <-> 标注
  \draw[BookRed,line width=1.2pt,<->] (32pt,18ex) -- (44pt,18ex);
  \draw[BookAmber,line width=1.2pt,<->] (44pt,18ex) -- (96pt,18ex);
  \draw[BookTeal,line width=1.2pt,<->] (96pt,18ex) -- (108pt,18ex);
  % 右侧图例（在 grid 外侧，紧贴右边界）
  \draw[BookRed,line width=2.5pt,->] (250pt,25ex) -- (265pt,25ex) node[right,font=\small\bfseries,BookRed] {\code{tCQ}};
  \draw[BookAmber,line width=2.5pt,->] (250pt,17ex) -- (265pt,17ex) node[right,font=\small\bfseries,BookAmber] {组合逻辑延迟};
  \draw[BookTeal,line width=2.5pt,->] (250pt,9ex) -- (265pt,9ex) node[right,font=\small\bfseries,BookTeal] {\code{tSU}};
\end{waveform}
...
\begin{waveform}[x=2pt,y=6ex]
  \draw[BookRule!20,step=20pt] (0,-18ex) grid (260pt,34ex);
  % CLK — 高:28ex, 低:22ex
  \draw[BookAccent,line width=3pt] (0,22ex) -- (0,28ex) -- (32pt,28ex) -- (32pt,22ex) -- (64pt,22ex) -- (64pt,28ex) -- (96pt,28ex) -- (96pt,22ex) -- (128pt,22ex) -- (128pt,28ex) -- (160pt,28ex) -- (160pt,22ex) -- (192pt,22ex) -- (192pt,28ex) -- (224pt,28ex) -- (224pt,22ex) -- (256pt,22ex) -- (256pt,28ex) -- (260pt,28ex);
  \node[BookAccent,left,font=\normalsize] at (0,25ex) {CLK};
  % Async input — 高:17ex, 低:11ex
  \draw[BookAmber,line width=3pt] (0,11ex) -- (80pt,11ex) -- (80pt,17ex) -- (200pt,17ex) -- (200pt,11ex) -- (260pt,11ex);
  \node[BookAmber,left,font=\normalsize] at (0,14ex) {async input};
  % FF1 — 高:6ex, 低:-2ex, 亚稳态振荡
  ...
  \draw[BookRed,line width=3pt] (240pt,4ex) -- (260pt,4ex);
  \node[BookRed,left,font=\normalsize] at (0,2ex) {FF$_1$ (meta)};
  % FF2 — 高:-8ex, 低:-14ex
  \draw[BookTeal,line width=3pt] (0,-14ex) -- (120pt,-14ex) -- (120pt,-8ex) -- (240pt,-8ex) -- (240pt,-14ex) -- (260pt,-14ex);
  \node[BookTeal,left,font=\normalsize] at (0,-11ex) {FF$_2$ (sync)};
  % Annotations — 在 grid 内部
  \node[BookRed,font=\small] at (100pt,32ex) {亚稳态};
...
\vspace{3.0em plus 1.0em}
\begin{block}[x=1.8cm,y=1.5cm]
  \node[draw, circle, minimum size=1.4cm, fill=BookCodeBg] (idle) {IDLE};
  \node[draw, circle, minimum size=1.4cm, fill=BookCodeBg, right=2.2cm of idle] (load) {LOAD};
  \node[draw, circle, minimum size=1.4cm, fill=BookCodeBg, right=2.2cm of load] (run) {RUN};
  \node[draw, circle, minimum size=1.4cm, fill=BookCodeBg, right=2.2cm of run] (done) {DONE};
  ...
  \draw[hw bus, bend left=50] (done) to node[below=0.6cm, hw label, pos=0.5]{clear=1} (idle);
