...
\input{chapters/ch05b-storage-cell-structures}
...
\part{控制面：平台、主板与反馈}
\begin{partbridge}
数据通路回答“数据从哪来到哪去”，控制面回答“谁、按什么规则、在什么时候让这一切发生”。本部分从寄存器接口与物理地址译码出发，经过芯片组、主板供电与时钟，最终收束到反馈控制理论——把整台机器写成一组从皮秒到秒嵌套的控制环。
\end{partbridge}
\input{chapters/ch-control-plane}
