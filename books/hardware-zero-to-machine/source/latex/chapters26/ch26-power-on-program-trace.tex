...
\begin{pdfdiagram}
  ...
  \draw[hw return] ($(alu.east)+(0,0.15)$) -- (4.4,0.6) -- (4.4,-3.6) -- (3.2,-3.6);
  ...
  \draw[hw return] ($(ctrl.east)+(0,0.15)$) -- (5.2,-3.75) -- (5.2,2.85);
  \draw[hw return] (5.2,2.85) -- ($(ir.east)+(0,0.15)$);
  \draw[hw return] (5.2,1.7) -- (acc.east);
  \draw[hw return] (5.2,0.3) -- ($(alu.east)+(0,-0.15)$);
  \draw[hw return] (5.2,-0.7) -- (regb.east);
  \fill[BookTeal] (-4.6,1.1) circle (0.05);
  \fill[BookTeal] (-4.6,-0.2) circle (0.05);
  \fill[BookTeal] (-4.6,-1.7) circle (0.05);
  \fill[BookTeal] (5.2,2.85) circle (0.05);
  \fill[BookTeal] (5.2,1.7) circle (0.05);
  \fill[BookTeal] (5.2,0.3) circle (0.05);
  \fill[BookTeal] (5.2,-0.7) circle (0.05);
...
\section{十二、功能安全案例：传感器输出卡滞后怎样在截止时间内关闭执行器}
