...
\section{十、Scatter-Gather DMA：离散页框怎样组成一笔连续设备请求}
...
\section{十一、中断重映射与 Posted Interrupt：设备消息怎样安全找到目标执行上下文}
...
\section{十二、一次 VM Entry 与 VM Exit：处理器怎样切换两套特权世界}
...
\section{十三、嵌套虚拟化与实时迁移：跨两层控制和两台主机}
