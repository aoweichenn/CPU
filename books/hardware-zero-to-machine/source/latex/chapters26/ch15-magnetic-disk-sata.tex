...
%======================================================================
\topic{记录技术演进：LMR、PMR、SMR、HAMR、MAMR}
...
\topic{双级执行器（Dual-Stage Actuator）}
...
容量、速度与“介质的物理特性”，这正是本章要一类设备一节分开讲的原
因。
...
NVMe 分区命名空间（ZNS）是同一思想：介质把约束公开给上层，软件按脾
气写，双方都轻松。
...
CMR。SMR 不是“坏盘”，它把“只能顺序写”这条介质的物理特性换成容量
