...
\begin{description}
  ...
  \item[GGML 量化格式] \code{Q4\_K}、\code{Q5\_0}、\code{Q6\_K}、\code{Q8\_0} 是 GGML/GGUF 生态里的量化权重 block 格式名。数字表示主要位宽，后缀表示 block 布局族；它们不是同一种矩阵，只能在 verifier 确认 shape、block size 和 type size 后交给对应 decoder 或 direct matvec。
