...
\section{三、SmolLM2 Small 模型 Smoke 工具}
...
\section{十三、Reference Decoder 完整实现}
...
\section{十五、Int8 Kernel AVX2 实现}
...
\section{二十四、Tiny Tokenizer Fixture}
