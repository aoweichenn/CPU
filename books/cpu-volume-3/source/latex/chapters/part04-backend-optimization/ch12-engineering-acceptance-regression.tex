\chapter{工程验收与回归体系：reference、测试、覆盖率、性能门禁和框架对标}
...
\section{coverage：覆盖率要服务风险，不服务数字}
...
\section{profiler schema：优化证据要可比较}
...
\section{一次 CPU kernel 优化的发布门禁示例}
