\chapter{从矩阵向量乘走向 GEMM、packing 与 SIMD}

\section{为什么不能直接从 matvec 跳到最快 GEMM}
...
\section{Packing 的本质：把坏地址流变成后端友好的地址流}
...
\section{从标量 reference 到 micro-kernel 的切分路线}
