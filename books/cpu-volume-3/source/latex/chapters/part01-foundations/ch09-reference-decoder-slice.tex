...
这条 trace 是 reference decoder 的最低门禁。若某个实现只告诉你“logits shape 是 \code{[16]}”，但不能说明第 0 层 position 2 的 K 写到了哪个 cache 坐标、query head 1 映射到哪个 KV head，它还不是可调试的 decoder。
