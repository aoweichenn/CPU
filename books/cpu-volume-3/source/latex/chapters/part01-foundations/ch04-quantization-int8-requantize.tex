\chapter{int8 量化、累加器与重新量化}

\section{从当前 lab 的简化路径开始，但落点是 7B 权重}
...
\section{为什么 accumulator 不能用 int8}
...
\section{zero point 修正项为什么会拖慢内核}
...
\section{对称、非对称、per-tensor、per-channel 与 per-group}
