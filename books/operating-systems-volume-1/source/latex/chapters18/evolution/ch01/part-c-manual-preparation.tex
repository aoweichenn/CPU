...
\begin{longtable}{|L{0.23\linewidth}|L{0.18\linewidth}|L{0.18\linewidth}|L{0.29\linewidth}|}
\hline
...
\node[stage,minimum width=2.8cm,below=13mm of record] (readback) {逐区读回核对};
\node[stage,minimum width=2.8cm,left=of readback] (commit) {最后写\\\code{prepared=1}};
