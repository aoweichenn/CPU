...
\begin{pdfdiagram}[x=1cm,y=1cm]
  \node[os control, minimum width=1.35cm] (isa) at (0,1.45) {ISA};
  \node[os compute, minimum width=1.65cm] (front) at (2.0,1.45) {fetch\\decode};
  \node[os compute, minimum width=1.65cm] (exec) at (4.0,1.45) {execute};
  \node[os state, minimum width=1.65cm] (retire) at (6.0,1.45) {retire};
  \node[os control, minimum width=1.65cm] (trap) at (8.0,1.45) {trap\\IRQ};
  \node[os control, minimum width=1.55cm] (kernel) at (10.0,1.45) {kernel};

  \node[os bit, minimum width=1.05cm] (va) at (0,-0.35) {VA};
  \node[os memory, minimum width=1.45cm] (tlb) at (2.0,-0.35) {TLB};
  \node[os memory, minimum width=1.65cm] (pt) at (4.0,-0.35) {page\\walk};
  \node[os bit, minimum width=1.05cm] (pa) at (6.0,-0.35) {PA};
  \node[os memory, minimum width=1.45cm] (cache) at (8.0,-0.35) {cache};
  \node[os memory, minimum width=1.45cm] (dram) at (10.0,-0.35) {DRAM};

  \node[os control, minimum width=1.45cm] (drv) at (0,-2.15) {driver};
  \node[os memory, minimum width=1.45cm] (ring) at (2.0,-2.15) {ring};
  \node[os control, minimum width=1.45cm] (db) at (4.0,-2.15) {doorbell};
  \node[os block, minimum width=1.45cm] (dev) at (6.0,-2.15) {device};
  \node[os memory, minimum width=1.45cm] (iommu) at (8.0,-2.15) {IOMMU};
  \node[os state, minimum width=1.55cm] (comp) at (10.0,-2.15) {completion};
  ...
  \draw[os feedback] (pt.north) .. controls +(0,0.95) and +(-2.8,-0.82) .. (kernel.south);
  \node[os label, fill=white, inner sep=1pt] at (3.0,0.12) {miss};
  \node[os label, fill=white, inner sep=1pt] at (6.8,0.83) {\#PF};
  ...
  \draw[os feedback] (comp.north) .. controls +(0,0.72) and +(1.45,-0.78) .. (kernel.south);
  \node[os label, fill=white, inner sep=1pt] at (9.35,0.22) {MSI-X};
\end{pdfdiagram}
...
\begin{pdfdiagram}[x=1cm,y=1cm]
  \node[os block, minimum width=1.45cm] (dev) at (0,0.75) {device};
  \node[os block, minimum width=1.65cm] (msix) at (2.05,0.75) {MSI-X\\msg};
  \node[os control, minimum width=1.75cm] (apic) at (4.55,0.75) {local\\APIC};
  \node[os control, minimum width=1.35cm] (cpu) at (6.75,0.75) {CPU};
  \node[os state, minimum width=1.35cm] (idt) at (8.7,0.75) {IDT};
  \node[os control, minimum width=1.55cm] (entry) at (10.65,0.75) {handler};

  \node[os block, minimum width=1.45cm] (timer) at (0,-1.05) {timer};
  \node[os block, minimum width=1.45cm] (ipi) at (2.05,-1.05) {IPI};
  ...
  \draw[os feedback] (entry.south) .. controls +(0,-1.2) and +(0,-1.2) .. (apic.south);
  \node[os label] at (3.3,1.18) {vector};
  \node[os label] at (7.6,-0.75) {EOI};
\end{pdfdiagram}
