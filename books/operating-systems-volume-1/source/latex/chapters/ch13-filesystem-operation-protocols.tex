...
\subsection{create：目录项是名字的可见性发布点}
...
\subsection{unlink：名字消失后的对象生命周期}
...
\subsection{truncate：同时收缩长度、缓存和块映射}
